...
| [#23](https://github.com/pablof7z/fipsd/issues/23) | Seed-stable tests cover all eleven traffic models, offered-load reconciliation, setup/teardown/rekey, idle and saturated baselines, and separate useful payload. |
